// ============================================
// FEATURED PROJECTS - Home Page Section
// ============================================
// This component displays featured projects on the home page
...
// Matches the backend ProjectResponseDto
type Project = {
  id: string;
  title: string;
  slug: string;
...
export default function FeaturedProjects({ projects }: FeaturedProjectsProps) {
  ...
  // Only show up to 4 featured projects
